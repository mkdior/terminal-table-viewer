...
const (
	...
	actPeek          action = "peek"
	actTogglePreview action = "toggle_preview"
...
var actionCatalog = []struct {
	...
	{actionInfo{actPeek, "View", "Show the full value of the current cell in the box, whatever its length, until the cursor moves or Esc closes it", false}, []string{"K"}},
	{actionInfo{actTogglePreview, "View", "Hide the full-value box that appears on its own, or show it again as the show setting says", false}, []string{"z K"}},
