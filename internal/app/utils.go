...
func getHelpContent() string {
	...
	sb.WriteString("  in a floating box while selected; K shows any cell's value there once,\n")
	sb.WriteString("  zK hides the automatic box or brings it back. Keys can be changed in\n")
	sb.WriteString("  the config file; see ttv --dump-config for the defaults.\n")
